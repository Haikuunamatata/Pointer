      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">Pointer</h3>
            <p className="text-gray-300 mb-6">
              A modern code editor with built-in AI assistance that runs entirely on your machine.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#get-started" className="text-gray-300 hover:text-primary transition-colors duration-300">
                  Get Started
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center text-gray-300">
          <p>&copy; {new Date().getFullYear()} Pointer. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
